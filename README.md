# Declarations of terms tracked in the *test21* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test21-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test21-versions/releases) in the `Ndpnt/test21-versions` repository.
